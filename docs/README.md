...
- **[API.md](./API.md)** — documentación completa de todos los endpoints (tipado, roles, request/response), flujos de usuario, mapa de integraciones y WebSocket. **Para consumidores del backend (frontend, QA, otros equipos).**
